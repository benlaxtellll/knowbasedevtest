...
exports.default = exports.dark = exports.light = exports.base = void 0;
...
var light = _objectSpread(_objectSpread({}, base), {}, {
  ...
  menuShadow: "0 0 0 1px rgba(0, 0, 0, 0.05), 0 4px 8px rgba(0, 0, 0, 0.08), 0 2px 4px rgba(0, 0, 0, 0.08)",
...
var dark = _objectSpread(_objectSpread({}, base), {}, {
  ...
  menuBorder: (0, _polished.lighten)(0.1, colors.almostBlack),
  menuBackground: (0, _polished.lighten)(0.015, colors.almostBlack),
  menuShadow: "0 0 0 1px rgba(0, 0, 0, 0.1), 0 8px 16px rgba(0, 0, 0, 0.3), 0 2px 4px rgba(0, 0, 0, 0.08), inset 0 0 1px rgba(255,255,255,.2)",
  divider: (0, _polished.darken)(0.2, colors.slate),
  ...
  horizontalRule: (0, _polished.darken)(0.2, colors.slate),
