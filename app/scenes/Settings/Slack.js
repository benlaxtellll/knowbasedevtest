      ...
      <CenteredContent>
        ...
        {this.error === "access_denied" && (
          <Notice>
            ...
            Knowbase to your team. Try again?
          </Notice>
        )}
        ...
        <HelpText>
          Preview Knowbase links your team mates share and use the{" "}
          <Code>/knowbase</Code> slash command in Slack to search for documents
          in your team’s wiki.
        </HelpText>
        <p>
        ...
        <h2>Collections</h2>
        <HelpText>
          Connect Knowbase collections to Slack channels and messages will be
